...
const slides = [
    '/academy/formations/social-investment/slide-1.jpg',
    '/academy/formations/social-investment/slide-2.jpg',
    '/academy/formations/social-investment/slide-3.jpg',
    '/academy/formations/social-investment/slide-4.jpg',
    '/academy/formations/social-investment/slide-5.jpg'
];

const quizQuestions = [
    {
        question: "Qui devez-vous interroger si vous avez une question pendant le processus ?",
        options: [
            "L'administration centrale",
            "Votre Chef d'équipe",
            "Les autres bénévoles uniquement",
            "Ne pas poser de questions"
        ],
        correct: 1
    },
    {
        question: "Quelle est la première phase du processus de décision d'investissement ?",
        options: [
            "Phase de décision et évaluation",
            "Phase de confirmation et test",
            "Phase de prise de connaissances",
            "Phase de collecte de fonds"
        ],
        correct: 2
    },
    {
        question: "Laquelle de ces caractéristiques est évaluée lors du mini-test ?",
        options: [
            "La couleur des vêtements",
            "Le lieu de naissance",
            "La stabilité et l'engagement",
            "La marque de téléphone"
        ],
        correct: 2
    },
    {
        question: "Quelle étape suit l'étude de projet dans l'accompagnement professionnel ?",
        options: [
            "Budget",
            "Collecte",
            "Mini Test",
...
export default function SocialInvestmentPage() {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-12 pb-20">
            ...
            <div className="flex items-center gap-6">
                ...
                <div>
                    <div className="flex items-center gap-2 mb-1">
                        <Target className="w-4 h-4 text-[#F2C830]" />
                        <span className="text-[10px] font-black uppercase text-[#F2C830] tracking-widest">Strategy Module</span>
                    </div>
                    <h1 className="text-2xl font-black text-[#134B5F]">Social Investment Process</h1>
                </div>
            </div>
                        ...
                        <div className="flex items-center justify-between mb-12">
                            <div className="flex items-center gap-4">
                                <div className="p-3 bg-yellow-50 rounded-2xl">
                                    <Brain className="w-6 h-6 text-[#F2C830]" />
                                </div>
                                <h2 className="text-xl font-black text-[#134B5F]">Vérification des Acquis</h2>
                            </div>
                            {!submitted && (
                            ...
                            <div className="space-y-8">
                                            ...
                                            {quizQuestions[currentQuizIdx].options.map((option, oIdx) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${isSelected ? 'border-[var(--color-accent)] bg-[var(--color-accent)]' : 'border-gray-200'}`}>
                                ...
                                <div className="flex items-center justify-between pt-8 border-t border-gray-100">
                                    <button
                                        ...
                                        className={`flex items-center gap-2 font-black text-xs uppercase tracking-widest transition-all ${currentQuizIdx === 0 ? 'opacity-0' : 'text-gray-400 hover:text-[#134B5F]'}`}
                                    >
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-500 font-medium italic">
                                        {score === quizQuestions.length
                                            ? "Excellent ! Vous maîtrisez parfaitement le processus."
                                            : "Bravo ! Prenez le temps de revoir les points manquants."}
                                    </p>
                                </div>
            ...
            {/* Support Note */}
            <div className="flex items-center gap-6 p-8 bg-blue-50/30 rounded-[2rem] border border-blue-100/50">
                <Lightbulb className="w-8 h-8 text-blue-500" />
                <p className="text-blue-700 text-sm italic">
                    <strong>Note :</strong> Cette formation est essentielle pour assurer la pérennité de nos actions.
                </p>
            </div>
        </div>
    );
